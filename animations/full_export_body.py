...
# befor export select objects which need to be export with sceleton (body, suit, etc.)
...
# make export dir
exp_dir_name = "export_body"

bpy.ops.object.select_pattern(pattern="Skeleton.Body.*", extend=False)
for obj in bpy.context.selected_objects:
    if (obj.name == "Skeleton.Body.Girl"):
        exp_dir_name = exp_dir_name + "_girl"
    elif (obj.name == "Skeleton.Body.Boy"):
...
bpy.ops.object.select_pattern(pattern="Skeleton.Body.*", extend=True)
