...
# make export dir
exp_dir_name = "export_head"

bpy.ops.object.select_pattern(pattern="Skeleton.Head.*", extend=False)
for obj in bpy.context.selected_objects:
    if (obj.name == "Skeleton.Head.Girl"):
        exp_dir_name = exp_dir_name + "_girl"
    elif (obj.name == "Skeleton.Head.Boy"):
        exp_dir_name = exp_dir_name + "_boy"
...
bpy.ops.object.select_all(action='DESELECT')
bpy.ops.object.select_pattern(pattern="Skeleton.Head.*", extend=True)
bpy.ops.object.select_pattern(pattern="eyeballs.*", extend=True)
bpy.ops.object.select_pattern(pattern="head.*", extend=True)
bpy.ops.object.select_pattern(pattern="teeth.*", extend=True)
