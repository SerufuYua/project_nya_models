...
bpy.ops.object.select_all(action='DESELECT')
bpy.ops.object.select_pattern(pattern="Sceleton.*", extend=True)
bpy.ops.object.select_pattern(pattern="toyA*", extend=True)
bpy.ops.object.select_pattern(pattern="hassock.*", extend=True)
